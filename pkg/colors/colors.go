...
// is of type color which unexported... This makes it so that the user has
// to use one of the exported constant color variables (which each map to
// a color). Haven't figured out if this is bad practice due to the second
